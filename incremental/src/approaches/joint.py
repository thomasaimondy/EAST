...
class Appr(object):
    ...
    def __init__(self,model,nepochs=100,sbatch=64,lr=0.05,lr_min=1e-3,lr_factor=3,lr_patience=5,clipgrad=10000,args=None):
        self.model=model
    ...
    def train(self,tasks,xtrain,ytrain,xvalid,yvalid):
        ...
        try:
            for e in range(self.nepochs):
                ...
                clock1=time.time()
                train_loss, _=self.eval_validation(task_t,xtrain,ytrain)
                clock2=time.time()
                ...
                print(' Valid: loss={:.3f} | Valid: acc={:.3f} |'.format(valid_loss, valid_acc),end='')
                # Adapt lr
