...
def get(seed=0, fixed_order=False, pc_valid=0, nclass=10,args=None,mini=None):
    nclass=10
    data = {}
    taskcla = []
    size = [1, 32, 32]
    ...
    if True:
        ...
        std = (1,)
        dat = {}
        root = root = '/home/user/jiashuncheng/E-Flow/dat/HWDB'
        ...
        for i, r in enumerate(seeds):
            ...
            for s in ['train', 'test']:
                ...
                data[i][s]['y'], indices = torch.sort(data[i][s]['y'])
                data[i][s]['x'] = data[i][s]['x'][indices]
        print()
