...
def get(seed=0,fixed_order=False,pc_valid=0, mini=False):
    ...
    for s in ['train','test']:
        ...
        for image,target in loader:
            ...
            if label==seeds[0] or label==seeds[1]:
                if label==seeds[0]:
            ...
            elif label==seeds[2] or label==seeds[3]:
                if label==seeds[2]:
            ...
            elif label==seeds[4] or label==seeds[5]:
                if label==seeds[4]:
            ...
            elif label==seeds[6] or label==seeds[7]:
                if label==seeds[6]:
            ...
            elif label==seeds[8] or label==seeds[9]:
                if label==seeds[8]:
