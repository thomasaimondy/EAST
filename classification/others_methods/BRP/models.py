            ...
            try:
                if layer[0] == "CONV":
                    ...
                    if (i == 0):
                        ...
                        input_dim = pow(int(output_dim) ,1) * int(topology_layers[i - 1][2]) *int(int(topology_layers[i - 1][1])/10) # /2 accounts for pooling operation of the previous convolutional layer
