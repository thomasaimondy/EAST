...
def load_dataset_cifar10(args, kwargs):
    ...
    train_loader     = torch.utils.data.DataLoader(datasets.CIFAR10('/mnt/lustre/xushuang4/jiashuncheng/code/drtp-final/DATASETS', train=True,  download=True, transform=transform_cifar10), batch_size=args.batch_size,      shuffle=True , **kwargs)
    traintest_loader = torch.utils.data.DataLoader(datasets.CIFAR10('/mnt/lustre/xushuang4/jiashuncheng/code/drtp-final/DATASETS', train=True,  download=True, transform=transform_cifar10), batch_size=args.test_batch_size, shuffle=False, **kwargs)
    test_loader      = torch.utils.data.DataLoader(datasets.CIFAR10('/mnt/lustre/xushuang4/jiashuncheng/code/drtp-final/DATASETS', train=False, download=True, transform=transform_cifar10), batch_size=args.test_batch_size, shuffle=False, **kwargs)
