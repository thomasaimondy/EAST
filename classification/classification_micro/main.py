...
def main():
    ...
    parser.add_argument('--test-batch-size', type=int, default=256, help='Input batch size for testing Default: 100.')
    parser.add_argument('--lr', type=float, default=1e-4, help='Learning rate. Default: 1e-4.')
    # Network
    #CONV_32_5_1_2_FC_1000_FC_10 C_100_3_1_1_FC_1000_FC_10 FC_4000_FC_3755   FC_4000_FC_1000  FC_2000_FC_1000 , FC_3755
    parser.add_argument('--topology', type=str, default='FC_1000_FC_10', help='Choice of network topology. Format for convolutional layers: CONV_{output channels}_{kernel size}_{stride}_{padding}. Format for fully-connected layers: FC_{output units}.')#CONV_8_3_1_1_FC_100_FC_10 'FC_30_FC_10';;'CONV_32_5_1_2_FC_1000_FC_10'
    parser.add_argument('--spike_window', type=int, default=100, help='The time clock for neurons. Default: 20.')#10,20,30
    ...
    parser.add_argument('--codename', type=str, default='MNIST_test_01') #'PM:CONV_32_3_1_1_CONV_64_3_1_1_FC_1000_FC_10' **'PM1:CONV_64_3_1_1_CONV_128_3_1_1_FC_1000_FC_10' **'PM2:PM1+5kernel '**PM3:PM2只最后一层更新
    ...
    parser.add_argument('--backstep', type=int, default=50, help='(default=%(default)d)')
    parser.add_argument('--Ntime', action='store_true')
    parser.add_argument('--n', type=int, default=10, help='(default=%(default)d)')
    parser.add_argument('--proportion', type=float, default=0)
    parser.add_argument('--insert', type=int, default=10, help='(default=%(default)d)')
    timeclock = time.strftime("%Y_%m_%d_%H_%M_%S", time.localtime())

    args = parser.parse_args()
    args.codename = timeclock + '_' +args.codename
    mkd(args)
    ...
    torch.manual_seed(args.seed)  # 42 50  10
